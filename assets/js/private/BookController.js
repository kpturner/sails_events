    ...
    */
    ...
    if (!canAmend) {
      ...
      if (
        ...
        SAILS_LOCALS.event.organiser2.username === SAILS_LOCALS.user.username
      );
    }
    if (
        ...
        ngDialog.openConfirm(opts).then(
          function (value) {
            ...
            $http
              ...
              .error(function (data, status, headers, config) {
                ngDialog.open(erOpts).closePromise.then(function (value) {
    ...
    $scope.bookingForm.menu5 = $scope.event.menu5;
    $scope.bookingForm.menu6 = $scope.event.menu6;
    $scope.bookingForm.menu7 = $scope.event.menu7;
    $scope.bookingForm.menu8 = $scope.event.menu8;
    $scope.bookingForm.menu9 = $scope.event.menu9;
    $scope.bookingForm.menu10 = $scope.event.menu10;
    ...
    $scope.proceed = function () {
      if ($scope.mode == "delete") {
        ...
        const postBooking = function (route) {
          ...
          if (
            $scope.event.recoverOnlinePaymentFee &&
            SAILS_LOCALS.booking.id &&
            SAILS_LOCALS.booking.paymentSessionId &&
            SAILS_LOCALS.booking.amountPaid &&
            SAILS_LOCALS.booking.places !== $scope.bookingForm.places
          ) {
