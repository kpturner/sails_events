...
angular.module('ui.bootstrap', [
        ...
        link: function (b, d, e) {
          function f() {
            d.removeClass('collapse').addClass('collapsing').attr('aria-expanded', !0).attr('aria-hidden', !1),
              c
                ? c(d, { addClass: 'in', easing: 'ease', to: { height: d[0].scrollHeight + 'px' } })
                    .start()
                    ['finally'](g)
                : a.addClass(d, 'in', { to: { height: d[0].scrollHeight + 'px' } }).then(g);
          }
          function g() {
          ...
          link: function (b, f, g) {
            function h() {
              f.removeClass('collapse').addClass('collapsing').attr('aria-expanded', !0).attr('aria-hidden', !1),
                e
                  ? e(f, { easing: 'ease', to: { height: f[0].scrollHeight + 'px' } })
                      .start()
                      .done(i)
                  : a.animate(f, {}, { height: f[0].scrollHeight + 'px' }).then(i);
            }
            function i() {
    ...
    .controller('AccordionController', [
      ...
      function (a, b, c, d, e) {
        e || d.warn('AccordionController is now deprecated. Use UibAccordionController instead.'),
          angular.extend(this, c('UibAccordionController', { $scope: a, $attrs: b }));
      }
    ])
    .directive('accordion', [
      '$log',
    ...
    .controller('AlertController', [
      ...
      function (a, b, c, d, e) {
        e || d.warn('AlertController is now deprecated. Use UibAlertController instead.'),
          angular.extend(this, c('UibAlertController', { $scope: a, $attrs: b }));
      }
    ])
    .directive('alert', [
      '$log',
      ...
      function (a, b, c, d) {
        ...
        (m.select = a.select =
          ...
          (m.addSlide = function (b, c) {
            (b.$element = c),
              n.push(b),
              1 === n.length || b.active ? (m.select(n[n.length - 1]), 1 === n.length && a.play()) : (b.active = !1);
          }),
    ...
    .controller('CarouselController', [
      ...
      function (a, b, c, d, e) {
        e || d.warn('CarouselController is now deprecated. Use UibCarouselController instead.'),
          angular.extend(this, c('UibCarouselController', { $scope: a, $element: b }));
      }
    ])
    .directive('carousel', [
      '$log',
          ...
          if (m && m.length) {
            ...
            angular.isDate(i) && !isNaN(i.getTime())
              ...
              : (i && a.warn('dateparser:', 'baseDate is not a valid date'),
                (n = { year: 1900, month: 0, date: 1, hours: 0, minutes: 0, seconds: 0, milliseconds: 0 }));
            ...
            return (
              e(n.year, n.month, n.date) &&
                (angular.isDate(i) && !isNaN(i.getTime())
                  ? ((o = new Date(i)),
                    o.setFullYear(n.year, n.month, n.date, n.hours, n.minutes, n.seconds, n.milliseconds || 0))
                  : (o = new Date(n.year, n.month, n.date, n.hours, n.minutes, n.seconds, n.milliseconds || 0))),
              o
            );
          }
        });
            ...
            b[d]
              ? a.$parent.$watch(c(b[d]), function (c) {
                  (i[d] = angular.isDefined(c) ? c : b[d]),
                    (a[d] = i[d]),
                    (('minMode' == d && i.modes.indexOf(a.datepickerMode) < i.modes.indexOf(i[d])) ||
                      ('maxMode' == d && i.modes.indexOf(a.datepickerMode) > i.modes.indexOf(i[d]))) &&
          ...
          (this._refreshView = function () {
            for (var b, d = new Array(12), e = this.activeDate.getFullYear(), f = 0; 12 > f; f++)
              (b = new Date(this.activeDate)),
                b.setFullYear(e, f, 1),
                (d[f] = angular.extend(this.createDateObject(b, this.formatMonth), { uid: a.uniqueId + '-' + f }));
          ...
          (this._refreshView = function () {
            for (var b, c = new Array(e), f = 0, g = d(this.activeDate.getFullYear()); e > f; f++)
              (b = new Date(this.activeDate)),
                ...
                (c[f] = angular.extend(this.createDateObject(b, this.formatYear), { uid: a.uniqueId + '-' + f }));
          ...
          (this.init = function (h) {
            if (
              ...
              k.html5Types[c.type]
                ...
                : ((r = c.datepickerPopup || c.uibDatepickerPopup || k.datepickerPopup),
            ...
            if (
              ((x = angular.element('<div uib-datepicker-popup-wrap><div uib-datepicker></div></div>')),
              x.attr({ 'ng-model': 'date', 'ng-change': 'dateSelection(date)', 'template-url': v }),
              (y = angular.element(x.children()[0])),
              y.attr('template-url', w),
              C && 'month' === c.type && (y.attr('datepicker-mode', '"month"'), y.attr('min-mode', 'month')),
              c.datepickerOptions)
            ) {
          ...
          (a.select = function (b) {
            if ('today' === b) {
              ...
              angular.isDate(a.date)
                ? ((b = new Date(a.date)), b.setFullYear(c.getFullYear(), c.getMonth(), c.getDate()))
            ...
            b[d]
              ? a.$parent.$watch(c(b[d]), function (c) {
                  (j[d] = angular.isDefined(c) ? c : b[d]),
                    (a[d] = j[d]),
                    (('minMode' == d && j.modes.indexOf(a.datepickerMode) < j.modes.indexOf(j[d])) ||
                      ('maxMode' == d && j.modes.indexOf(a.datepickerMode) > j.modes.indexOf(j[d]))) &&
          ...
          (a.toggleMode = function (b) {
            (b = b || 1),
              (a.datepickerMode === j.maxMode && 1 === b) ||
                ...
                (a.datepickerMode = j.modes[j.modes.indexOf(a.datepickerMode) + b]);
          }),
          (a.keys = {
            13: 'enter',
            32: 'space',
        ...
        b.addClass('dropdown'),
            ...
            switch (a) {
              case 40:
                angular.isNumber(n.selectedOption)
                  ? (n.selectedOption = n.selectedOption === c.length - 1 ? n.selectedOption : n.selectedOption + 1)
                  : (n.selectedOption = 0);
                break;
              case 38:
                angular.isNumber(n.selectedOption)
          ...
          o.$watch('isOpen', function (c, d) {
            if (s && n.dropdownMenu) {
              ...
              m
                ? ((i.left = 'auto'), (i.right = window.innerWidth - (e.left + b.prop('offsetWidth')) + 'px'))
            ...
            switch (a) {
              case 40:
                angular.isNumber(p.selectedOption)
                  ? (p.selectedOption = p.selectedOption === c.length - 1 ? p.selectedOption : p.selectedOption + 1)
                  : (p.selectedOption = 0);
                break;
              case 38:
                angular.isNumber(p.selectedOption)
                  ...
                  switch (a.which) {
                    case 40:
                      angular.isNumber(f.selectedOption)
                        ? (f.selectedOption =
                            f.selectedOption === b.length - 1 ? f.selectedOption : f.selectedOption + 1)
                        : (f.selectedOption = 0);
                      break;
                    case 38:
                      angular.isNumber(f.selectedOption)
                        ? (f.selectedOption = 0 === f.selectedOption ? 0 : f.selectedOption - 1)
      ...
      function (a, b, c) {
        function d(b, d, f) {
          d.addClass('modal-backdrop'),
            f.modalInClass &&
              (e ? e(d, { addClass: f.modalInClass }).start() : a.addClass(d, f.modalInClass),
            ...
            link: function (d, f, g) {
              ...
              g.$observe('modalRender', function (a) {
                ...
                h.promise.then(function () {
                  var h = null;
                  g.modalInClass &&
                    ((h = e ? e(f, { addClass: g.modalInClass }).start() : c.addClass(f, g.modalInClass)),
            ...
            if (b && b.value.keyboard)
              switch (a.which) {
                ...
                case 9:
                  ...
                  var c = !1;
                  a.shiftKey
                    ? w.isFocusInFirstItem(a) && (c = w.focusLastFocusableElement())
                        ...
                        function (a) {
                          ...
                          b.controller &&
                            ...
                            Object.defineProperty(j, '$modalInstance', {
                              get: function () {
                                return (
                                  h || i.warn('$modalInstance is now deprecated. Use $uibModalInstance instead.'), p
                                );
                              }
                            }),
                            ...
                            (e = f(b.controller, j)),
                            b.controllerAs && (b.bindToController && angular.extend(e, d), (d[b.controllerAs] = e))),
                            g.open(p, {
                              scope: d,
                              deferred: l,
                              renderDeferred: o,
      ...
      function (a, b, c, d, e) {
        function f(b, f, h) {
          e || d.warn('modal-backdrop is now deprecated. Use uib-modal-backdrop instead.'),
            ...
            h.modalInClass &&
              (g ? g(f, { addClass: h.modalInClass }).start() : a.addClass(f, h.modalInClass),
              b.$on(c.NOW_CLOSING_EVENT, function (b, c) {
                var d = c();
            ...
            link: function (d, h, i) {
              ...
              i.$observe('modalRender', function (a) {
                ...
                j.promise.then(function () {
                  var e = null;
                  i.modalInClass &&
                    ((e = g ? g(h, { addClass: i.modalInClass }).start() : c.addClass(h, i.modalInClass)),
                    d.$on(a.NOW_CLOSING_EVENT, function (a, b) {
                      var d = b();
                      g
        ...
        (this.init = function (g, h) {
          ...
          (a.selectPage = function (b, c) {
            ...
            d &&
              ...
              b > 0 &&
              b <= a.totalPages &&
              (c && c.target && c.target.blur(), e.$setViewValue(b), e.$render());
          }),
          (a.getText = function (b) {
        ...
        (this.init = function (d, e) {
          ...
          (a.selectPage = function (b, c) {
            ...
            d &&
              ...
              b > 0 &&
              b <= a.totalPages &&
              (c && c.target && c.target.blur(), g.$setViewValue(b), g.$render());
          }),
          (a.getText = function (b) {
        ...
        return {
          ...
          link: function (e, f, g, h) {
            ...
            function j(a, b) {
              ...
              f &&
                (n
                  ? ((d = Math.max(a - Math.floor(m / 2), 1)), (e = d + m - 1), e > b && ((e = b), (d = e - m + 1)))
                  : ((d = (Math.ceil(a / m) - 1) * m + 1), (e = Math.min(d + m - 1, b))));
              for (var g = d; e >= g; g++) {
                var h = i(g, g, g === a);
                c.push(h);
              }
  ...
  angular
    ...
    .provider('$uibTooltip', function () {
      ...
      var b = { placement: 'top', animation: !0, popupDelay: 0, popupCloseDelay: 0, useContentExp: !1 },
        c = { mouseenter: 'mouseleave', click: 'click', focus: 'blur', none: '' },
        d = {};
              ...
              function (e, k, m, o) {
                ...
                var q = a(e),
                  ...
                  t =
                    ...
                    s +
                    '" ' +
                    (o.useContentExp ? 'content-exp="contentExp()" ' : 'content="' + r + 'content' + s + '" ') +
                    'placement="' +
                    r +
                    'placement' +
                    s +
                ...
                return {
                  compile: function (a, b) {
                    ...
                    return function (a, b, d, f) {
                      ...
                      function m() {
                        (!K || a.$eval(d[k + 'Enable'])) &&
                          (u(), x(), L.popupDelay ? F || (F = g(r, L.popupDelay, !1)) : r());
                      }
                      function q() {
                      ...
                      var C,
                        ...
                        G,
                        H,
                        I = angular.isDefined(o.appendToBody) ? o.appendToBody : !1,
                        J = p(void 0),
    ...
    .controller('RatingController', [
      ...
      function (a, b, c, d, e) {
        e || d.warn('RatingController is now deprecated. Use UibRatingController instead.'),
          angular.extend(this, c('UibRatingController', { $scope: a, $attrs: b }));
      }
    ])
    .directive('rating', [
      '$log',
    ...
    .controller('TimepickerController', [
      ...
      function (a, b, c, d, e, f) {
        f || e.warn('TimepickerController is now deprecated. Use UibTimepickerController instead.'),
          angular.extend(this, d('UibTimepickerController', { $scope: a, $element: b, $attrs: c }));
      }
    ])
    ...
    .controller('UibTypeaheadController', [
      ...
      function (a, b, c, d, e, f, g, h, i, j, k, l) {
        ...
        var t,
          ...
          H = e(c.ngModel + '($$$p)'),
          I = function (b, c) {
            return angular.isFunction(G(a)) && p && p.$options && p.$options.getterSetter
              ? H(b, { $$$p: c })
              : G.assign(b, c);
          },
                  ...
                  if (f && t)
                    if (e && e.length > 0) {
                      ...
                      for (var g = 0; g < e.length; g++)
                        (d[J.itemName] = e[g]), K.matches.push({ id: P(g), label: J.viewMapper(K, d), model: e[g] });
                      (K.query = c),
                        n(),
            ...
            if (0 !== K.matches.length && -1 !== q.indexOf(a.which)) {
              ...
              a.preventDefault(),
                40 === a.which
                  ...
                  : 38 === a.which
                  ? ((K.activeIdx = (K.activeIdx > 0 ? K.activeIdx : K.matches.length) - 1), K.$digest())
        ...
        h.bind('click', W),
          a.$on('$destroy', function () {
            h.unbind('click', W),
              (C || D) && X.remove(),
              C && (angular.element(i).unbind('resize', m), h.find('body').unbind('scroll', m)),
              N.remove();
          });
        var X = d(N)(K);
          ...
          (this.init = function (b, c) {
            (o = b),
              ...
              o.$parsers.unshift(function (b) {
                return (
                  (t = !0),
                  0 === s || (b && b.length >= s) ? (v > 0 ? (V(), U(b)) : R(b)) : (x(a, !1), V(), O()),
                  w ? b : b ? void o.$setValidity('editable', !1) : (o.$setValidity('editable', !0), null)
                );
              }),
        ...
        return {
          ...
          link: function (n, o, p, q) {
            ...
            var w,
              ...
              K = b(p.ngModel + '($$$p)'),
              L = function (a, b) {
                return angular.isFunction(J(n)) && u && u.$options && u.$options.getterSetter
                  ? K(a, { $$$p: b })
                  : J.assign(a, b);
              },
                      ...
                      if (d && w)
                        if (c && c.length > 0) {
                          ...
                          for (var e = 0; e < c.length; e++)
                            (b[M.itemName] = c[e]),
                              N.matches.push({ id: S(e), label: M.viewMapper(N, b), model: c[e] });
                          (N.query = a),
                            s(),
            ...
            t.$parsers.unshift(function (a) {
              return (
                (w = !0),
                0 === v || (a && a.length >= v) ? (y > 0 ? (Y(), X(a)) : U(a)) : (A(n, !1), Y(), R()),
                z ? a : a ? void t.$setValidity('editable', !1) : (t.$setValidity('editable', !0), null)
              );
            }),
              ...
              o.bind('keydown', function (a) {
                if (0 !== N.matches.length && -1 !== l.indexOf(a.which)) {
                  ...
                  a.preventDefault(),
                    40 === a.which
                      ? ((N.activeIdx = (N.activeIdx + 1) % N.matches.length), N.$digest())
                      : 38 === a.which
            ...
            e.bind('click', Z),
              n.$on('$destroy', function () {
                e.unbind('click', Z),
                  (F || G) && $.remove(),
                  F && (angular.element(f).unbind('resize', r), e.find('body').unbind('scroll', r)),
                  Q.remove();
              });
            var $ = a(Q)(N);
    ...
    .filter('typeaheadHighlight', [
      ...
      function (a, b, c, d) {
        ...
        return (
          ...
          function (b, h) {
            return (
              d || c.warn('typeaheadHighlight is now deprecated. Use uibTypeaheadHighlight instead.'),
